...
on wszystkich wymyślnych elementów wu-ftpd, jest jednak
prawdopodobniej mniej zapluskwiony i bardziej bezpieczny (w każdym
razie był takim zanim go przeniosłem na Linuksa, i mam nadzieję, że
nie nabałaganiłem *za bardzo*). Kod źródłowy pochodzi z repozytorium
CVS OpenBSD z dnia 2000/07/07 (tj. po wersji 2.7). Numer wersji ftpd
to 6.5, zaś numer wersji tego portu to 0.3.2.

Pakiet przychodzi z wyłączonym anonimowym uploadem. Jeśli naprawdę
chcesz go włączyć - zmień uprawnienia do /home/services/ftp/upload na
0730.
